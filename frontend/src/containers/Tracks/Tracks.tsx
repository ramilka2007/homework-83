...
import {selectAlbum, selectIsLoadingAlbum} from "../../features/albums/albumSlice";
import {selectArtist, selectIsLoadingArtist} from "../../features/artists/artistsSlice";
import {selectIsLoadingTracks, selectTracks} from "../../features/tracks/tracksSlice";
      ...
      <div className="container">
        {tracksLoading && artistLoading && albumsLoading ? <Spinner/> :
            <div className="cursor-card">
              <h1 className="mb-2">Artist: {artistOfAlbum ? artistOfAlbum.artist : "Not found"}</h1>
