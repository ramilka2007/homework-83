...
const tracksHistorySlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(postTrackToHistoryById.pending, (state: tracksHistoryState) => {
      state.isLoading = true;
      state.isError = false;
    });
    builder.addCase(postTrackToHistoryById.fulfilled, (state: tracksHistoryState) => {
      state.isLoading = false;
    });
    builder.addCase(postTrackToHistoryById.rejected, (state: tracksHistoryState) => {
      state.isLoading = false;
      state.isError = true;
    });
    ...
    builder.addCase(getTrackToHistory.fulfilled, (state: tracksHistoryState, {payload: tracks}) => {
